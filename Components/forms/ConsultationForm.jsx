  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit}>
          ...
          {currentStep === 3 && (
            ...
            >
              ...
              <div>
                ...
                <div className="border border-dashed border-charcoal p-6 text-center hover:border-slate transition-colors">
                  <input
                    type="file"
                    id="designPhotos"
                    accept="image/*"
                ...
                {formData.designPhotos.length > 0 && (
                  <div className="mt-3 flex flex-wrap gap-2">
                    {formData.designPhotos.map((file, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-2 bg-charcoal px-3 py-1 text-sm"
                      >
              ...
              <div>
                ...
                {formData.handPhoto && (
                  <div className="mt-3 flex items-center gap-2 bg-charcoal px-3 py-2">
        ...
        {/* Navigation Buttons */}
        <div className="flex justify-between mt-8 pt-6 border-t border-charcoal">
          {currentStep > 1 ? (
            <button
              type="button"
              onClick={prevStep}
