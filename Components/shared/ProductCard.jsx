  ...
  return (
    ...
    >
      <Link href={`/product/${product.id}`} className="block">
        {/* Image Container */}
        <div className="relative aspect-square bg-gradient-to-br from-gray-900 to-gray-800 overflow-hidden mb-4">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              {(() => {
                ...
                return (
                  <div className="w-16 h-16 mx-auto mb-2 rounded-full bg-gray-700/50 flex items-center justify-center">
          ...
          <div className="absolute top-3 left-3">
            <span
              className={`px-2 py-1 text-xs font-inter uppercase tracking-wider ${
          ...
          {product.featured && (
            <div className="absolute top-3 right-3">
              <span className="px-2 py-1 bg-[#8b0000] text-white text-xs font-inter uppercase tracking-wider">
                Featured
              </span>
            </div>
          )}
          ...
          {isLegendary && (
            <div className="absolute bottom-3 left-3 right-3">
              <div className="bg-black/80 backdrop-blur-sm px-3 py-2 text-center">
