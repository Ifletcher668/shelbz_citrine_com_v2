            ...
            <div className="flex-1 overflow-y-auto px-6 py-4">
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-gray-400 font-inter mb-2">Your collection awaits</p>
                  ...
                  <Link
                    href="/store"
                    onClick={closeCart}
                    className="inline-flex items-center px-6 py-3 bg-[#8b0000] text-white text-sm font-inter uppercase tracking-wider hover:bg-[#6b0000] transition-colors"
                  >
                    Explore Collections
                  ...
                  {items.map((item) => (
                    <li key={`${item.product.id}-${item.size}`} className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-white font-cormorant text-base truncate">
                          {item.product.name}
                        </h3>
            ...
            {items.length > 0 && (
              <div className="border-t border-gray-800 px-6 py-4 space-y-4">
                ...
                <Link
                  href="/checkout"
                  onClick={closeCart}
                  className="block w-full py-4 bg-[#8b0000] text-white text-center text-sm font-inter uppercase tracking-wider hover:bg-[#6b0000] transition-colors"
                >
                  Proceed to Checkout
                </Link>
                ...
                <button
                  onClick={closeCart}
                  className="block w-full py-3 border border-gray-700 text-gray-300 text-center text-sm font-inter uppercase tracking-wider hover:border-gray-500 hover:text-white transition-colors"
                >
                  Continue Shopping
                </button>
              </div>
