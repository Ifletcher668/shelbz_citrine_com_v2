      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <p className="text-lg">
            ...
            template selection and true bespoke design, you begin to see what
            makes heirloom jewelry worthy of being passed down through
            generations.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-space-8 max-w-6xl mx-auto mt-16">
          {/* Problems Column - DARK & OPPRESSIVE */}
          <motion.div
            initial={{ opacity: 0, x: -40 }}
            animate={isInView ? { opacity: 1, x: 0 } : {}}
            transition={{ duration: 1, delay: 0.3, ease: [0.16, 1, 0.3, 1] }}
            className="bg-stone-deeper tension-border heavy-shadow p-10 relative"
          >
            {/* Dark corner accent */}
            <div className="absolute top-0 left-0 w-12 h-12 border-l-2 border-t-2 border-steel-blue/40" />

            <h3 className="font-mono text-sm uppercase tracking-wider text-fog/70 mb-10 text-center">
              The Standard
            </h3>
          ...
          <motion.div
            ...
            animate={isInView ? { opacity: 1, x: 0 } : {}}
            transition={{ duration: 1, delay: 0.3, ease: [0.16, 1, 0.3, 1] }}
            className="bg-stone-dark border border-fog/20 heavy-shadow p-10 relative"
          >
            {/* Gold corner accent */}
            <div className="absolute top-0 right-0 w-12 h-12 border-r-2 border-t-2 border-pale-gold/40" />

            <h3 className="font-mono text-sm uppercase tracking-wider text-pale-gold mb-10 text-center">
              Our Alternative
            </h3>
        ...
        >
          <p className="text-sm text-fog italic">
            The word "bespoke" derives from 16th-century Savile Row tailoring. A
            client would select fabric, and the tailor would mark it as "spoken
            for"—claimed before shears touched wool. The process involved
            measurements, hand-cut patterns, multiple fittings, adjustments for
            posture and movement. The word meant collaboration from first sketch
            to final stitch. A bespoke suit took weeks because the tailor was
            solving for how a specific human body moved through space.
          </p>
        </motion.div>
      </div>
    </section>
