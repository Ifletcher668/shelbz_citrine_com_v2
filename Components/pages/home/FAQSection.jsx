  ...
  return (
    <section ref={ref} className="section bg-void relative">
      <div className="section-container relative z-10">
            ...
            <div className="flex flex-col gap-space-6">
              {faqs.map((faq, index) => (
                <AccordionItem
                  key={index}
                  value={`item-${index}`}
                  className="bg-stone-deeper border border-fog/20 heavy-shadow px-8 md:px-12 transition-all duration-700 data-[state=open]:border-pale-gold"
                >
                  <AccordionTrigger className="text-left font-mono text-sm hover:text-pale-gold py-8 uppercase tracking-wide transition-colors duration-500">
                    {faq.question}
                  </AccordionTrigger>
        ...
        >
          <div className="flex flex-col gap-space-8 mt-16 max-w-4xl mx-auto text-center">
