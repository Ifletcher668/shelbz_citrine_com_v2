        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="flex flex-col gap-space-6">
              ...
              <p className="text-md text-fog">
                We'll discuss budget, timeline, metal options, stone selection,
                and design constraints (some ideas look great on Pinterest but
                fail in practice—we'll tell you why). If at the end you decide
                to go elsewhere, we'll shake hands and wish you well. If you
                want to move forward, we'll start sketching.
              </p>
              <p className="text-sm text-fog/80 italic">
                ...
                We'll photograph your hands if designing for fit. No commitment
                required.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-col gap-space-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-space-8 max-w-4xl mx-auto mt-12 pt-12 border-t border-fog/10">
