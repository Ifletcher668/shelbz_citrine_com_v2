                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex flex-col md:flex-row gap-4 items-start">
                      ...
                      <div className="flex flex-col gap-5 flex-1">
                        ...
                        <Link
                          href={`/blog/${post.slug}`}
                          className="inline-flex items-center gap-4 font-display text-sm text-pale-gold hover:text-silver-white uppercase tracking-wider transition-colors duration-500"
                        >
