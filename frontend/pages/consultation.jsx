        ...
        <main>
          <Section variant="hero">
            <div className="section-narrow">
              ...
              {/* Progress Bar */}
              <div className="flex flex-col gap-5 mt-space-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          {[
                            ...
                            >
                              ...
                              {formData.consultationType === option.value && (
                                <div className="absolute top-1 right-2 w-3 h-3 bg-pale-gold rounded-full shadow-[0_0_10px_rgba(180,170,150,0.6)]" />
                              )}
                            </button>
                          ))}
                        </div>
