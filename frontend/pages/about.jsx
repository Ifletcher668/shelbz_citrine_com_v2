              ...
              <div className="flex flex-col gap-12">
                ...
                <div className="flex flex-col gap-8 max-w-4xl mx-auto">
                  <p>
                    ...
                    beautiful goods and the lack of accessible supply. There are
                    artisans in India and Thailand who still practice kundan
                    setting—the same technique that secured gemstones in Mughal
                    court jewelry. Their workshops don't have websites. They
                    don't ship to Amazon. They work through partnerships with
                    people who understand what they do and can explain it to
                    clients 8,000 miles away.
                  </p>
                  <p>
                    ...
                    learned the same way. The apprenticeship system that trained
                    him is older than the United States. When he sets a black
                    spinel using pure 24kt gold foil and a burnisher, he's using
                    the same method described in 5th-century CE treatises on
                    craft.
                  </p>
              ...
              <div className="flex flex-col gap-12">
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <p>
                    ...
                    gamma rays, and fracture-filled with glass). The FTC allows
                    this. Consumers don't know to ask.
                  </p>
                  <p>
                    <strong className="text-silver-white">
                      "Ethical sourcing"
                    </strong>{" "}
                    used to mean direct relationships with miners who are fairly
                    compensated and work safely. Now it means "we bought from a
                    supplier who filled out the right paperwork." The chain of
                    custody is whatever you want it to be if you're willing to
                    pay for the right certifications.
                  </p>
                  <p>
                    <strong className="text-silver-white">"Bespoke"</strong>{" "}
                    derives from 16th-century tailoring: fabric that has been
                    "spoken for"—claimed by a specific client before shears ever
                    touched wool. A Savile Row tailor would take measurements,
                    sketch the pattern, cut the cloth, and shape it to the
                    client's body through multiple fittings. The word meant
                    collaboration from the first conversation to the final
                    stitch. Now it means picking from three pre-designed options
                    and getting your name engraved on the inside.
                  </p>
                </div>
              </div>
            </motion.div>
                  ...
                  <div className="bg-stone-deeper border border-fog/20 heavy-shadow p-10 relative">
                    ...
                    <div className="flex flex-col gap-8 text-lg">
                      ...
                      <p>
                        ...
                        been metalworking for over a century. The grandfather of
                        the man who might forge your ring learned his trade in
                        the 1920s. His father learned in the 1950s.
                        ...
                        of orders from returning clients doesn't need Instagram.
                      </p>
                      <p>
                        ...
                        individually with tweezers and heat—an ancient Etruscan
                        technique). Repoussé (shaping metal from the reverse
                        side to create relief patterns). Hand-engraving with
                        tools older than the building.
                      </p>
                      <p>
                        <strong className="text-pale-gold">
                          What they don't do:
                        ...
                        quality. Design work that violates material logic (if it
                        can't be made without structural weakness, they'll tell
                        you why and suggest alternatives).
                      </p>
                      <p className="text-fog italic text-sm pt-8 border-t border-fog/20">
                        ...
                        enough to burnish between stone and metal but not so hot
                        it melts. Too cool and the bond fails. Too hot and
                        you've ruined the setting. This is knowledge learned
                        through years of watching someone who learned by
                        watching someone else. Your ring takes 4-8 weeks because
                        rushing produces structural flaws that appear six months
                        after you start wearing it daily.
                      </p>
                    </div>
                    ...
                    >
                      <div className="flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-6">
                          ...
                          <p className="text-3xl text-pale-gold">{item.stat}</p>
                        </div>
