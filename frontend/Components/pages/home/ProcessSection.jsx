        ...
        <div className="flex flex-col gap-12">
          ...
          >
            <div className="flex flex-col gap-8">
              <h2 className="text-4xl md:text-5xl">The Process</h2>
              <p className="text-lg">
                Five steps from consultation to delivery.
              </p>
            </div>
          </motion.div>
                ...
                return (
                  ...
                  >
                    <div className="flex flex-row md:flex-col items-start md:items-center gap-6 md:gap-0">
                      ...
                      {/* Step Content - Sparse */}
                      <div className="flex flex-col gap-6 md:mt-8 md:text-center flex-1">
