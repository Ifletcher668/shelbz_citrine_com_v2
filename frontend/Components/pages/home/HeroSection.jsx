        ...
        <div className="flex flex-col gap-12">
          ...
          >
            <div className="flex flex-col gap-8">
              ...
              <p>
                {" "}
                Many gems are forged with the same techniques and passion. But
                our crown jewel? Black Spinel: Harder than most gemstones.{" "}
              ...
              <p>
                ...
                centuries—methods that prioritize durability over speed,
                integrity over volume. Above all, we prioritize the quality of
          ...
          <motion.div
            ...
            className="max-w-4xl mx-auto"
          >
            <div className="aspect-video bg-stone-dark border border-stone-grey/10 heavy-shadow relative overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
                <Sparkles className="w-12 h-12 text-pale-gold/20 mb-3" />
                <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-stone-grey/90">
                  Hero Image Placeholder
                </p>
                <p className="text-xs text-stone-grey/70 mt-1">
