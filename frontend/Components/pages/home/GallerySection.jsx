        ...
        <div className="flex flex-col gap-12">
          ...
          >
            <div className="flex flex-col gap-8">
              ...
              <p className="text-lg">
                Each piece tells a story—not the marketing kind, but the real
                kind. Client requests, material constraints, artisan solutions.
                These are commissions we've completed, photographed with
                permission, and cataloged like museum specimens.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="bg-stone-dark border-2 border-fog/20 heavy-shadow relative">
                ...
                <div className="border-t border-fog/20 p-8 bg-stone-deeper/50">
                  <div className="flex flex-col gap-8">
                    ...
                    <p className="text-md">{selectedImage.description}</p>
                  </div>
                </div>
              </div>
            </motion.div>
