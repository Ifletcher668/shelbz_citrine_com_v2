// Product data for Shelbz Citrine
...
export const collections = {
  adventurer: {
    ...
    description:
      "Heavy sterling silver and 14k gold pieces featuring top-tier black spinel. Complex Rajasthani craftsmanship refined for the modern dark romantic. Your first legendary find.",
    priceRange: "$85 - $650",
  ...
  bridal: {
    ...
    description:
      "Solid 18k gold or platinum. Intricate enamel work hidden inside bands. Large, perfect-cut spinel and exotic gems for those who refuse traditional diamonds.",
  ...
  legendary: {
    ...
    description:
      "Bespoke artifacts crafted through private consultation. Heritage Damascus blades, gemstone dice sets, and silk pieces worthy of a dynasty. Not available via cart—by appointment only.",
    priceRange: "$1,800+",
...
export const products = [
  // === ADVENTURER COLLECTION ($500 - $2,000) ===
  {
    ...
    price: 385,
    images: [
      "/products/obsidian-signet-1.jpg",
      "/products/obsidian-signet-2.jpg",
    ],
...
Each piece is hand-finished by artisans whose families have worked precious metals for seven generations. The black spinel—sourced directly from our partner mines—exhibits the deep, mirror-like finish that collectors prize above common onyx.`,
  ...
  },
  {
    ...
    category: "pendants",
    price: 520,
    images: ["/products/midnight-drop-1.jpg", "/products/midnight-drop-1.jpg"],
...
The reverse reveals a hidden detail: a miniature lotus pattern in recessed enamel, visible only to the wearer. A secret between you and the craftsman who placed it there.`,
    ...
    provenance:
      "Crafted in Jaipur using techniques preserved since the Mughal era",
    inStock: true,
    featured: true,
  },
  {
    ...
    shortDescription:
      "Oxidized sterling silver band with skeletal lattice motif",
...
This ring speaks to those who find beauty in contrast—light against dark, polish against patina. The memento mori tradition rendered in precious metal by hands that have shaped silver for generations.`,
  ...
  },
  {
    ...
    shortDescription:
      "Sterling silver cuff with geometric patterns and spinel accents",
...
Five black spinels are set at key intersection points. The interior is polished smooth for comfortable daily wear, while the exterior tells a story written in silver and stone by artisans who learned these patterns from their fathers, who learned from theirs.`,
  ...
  },
  {
    ...
    shortDescription:
      "Sterling silver drop earrings with black spinel teardrops",
...
For those who prefer their luxury understated. These speak quietly but carry weight.`,
    materials: [
      "Sterling Silver (925)",
      "Natural Black Spinel (2 x 1.5ct pear cut)",
    ],
...
This is the silk that once dressed royalty. Now it dresses you.`,
  ...
  // === HEIRLOOM COLLECTION ($3,000 - $10,000) ===
  {
    ...
    price: 2800,
    images: [
      "/products/dark-covenant-1.jpg",
      "/products/dark-covenant-2.jpg",
      "/products/dark-covenant-3.jpg",
    ],
    shortDescription:
      "18k white gold ring with 3ct black spinel and hidden enamel",
...
The true detail lies within: lift the ring and discover hidden enamel work inside the band. A private symbol known only to you and yours. Each ring is unique—share your story, and our artisans will encode it in enamel.`,
    materials: [
      "18k White Gold",
      "Natural Black Spinel (3ct center)",
      "Black Diamond Pavé (0.5ct total)",
      "Custom Enamel Interior",
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Platinum ring with rare grey spinel and black diamond accents",
...
The band features a knife-edge profile for modern minimalism, while the setting employs centuries-old techniques. It looks like a simple, expensive band—until light catches the stone and reveals depths within.`,
    materials: [
      "Platinum (950)",
      "Natural Grey Spinel (4ct)",
      "Black Diamonds (1ct total)",
    ],
...
This piece draws from both Rajasthani naga imagery and Victorian mourning traditions. For those who understand that beauty often carries an edge.`,
    materials: [
      "18k Yellow Gold",
      "Natural Black Spinel (1.5ct)",
      "Cabochon Rubies (eyes)",
    ],
...
Finished with hand-rolled edges. The silk has weight and drape that synthetic fabrics cannot replicate.`,
  ...
  // === LEGENDARY SHOWCASE (Display Only - $15,000+) ===
  {
    ...
    shortDescription:
      "Full polyhedral set in solid 18k gold with gemstone inlays",
...
**This piece is displayed as an example of our Legendary capabilities. All Legendary pieces begin with a private consultation.**`,
    materials: [
      "Damascus Steel (Wootz method)",
      "Sterling Silver Hilt",
      "Ray Skin Wrap",
      "Black Spinel Pommel (3ct)",
    ],
...
**This piece is displayed as an example of our Legendary capabilities. All Legendary pieces begin with a private consultation.**`,
  ...
  },
  {
    ...
    shortDescription:
      "Full-length Damascus blade with gold and gemstone fittings",
