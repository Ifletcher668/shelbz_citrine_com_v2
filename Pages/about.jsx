            ...
            <Container className="relative z-10">
              ...
              >
                <div className="flex flex-col gap-space-8">
                  ...
                  <div className="flex flex-col gap-space-6 max-w-4xl mx-auto">
                    <p>
              ...
              >
                <div className="flex flex-col gap-space-8">
                  ...
                  <div className="max-w-4xl mx-auto">
                    <div className="bg-stone-deeper border border-fog/20 heavy-shadow p-12 relative">
                      {/* Corner accents */}
                      ...
                      <div className="flex flex-col gap-space-6 text-lg">
                        <p>
                        ...
                        <p className="text-fog italic text-sm pt-6 border-t border-fog/20">
                      ...
                      <div className="flex flex-col gap-space-10">
                        ...
                        <div className="flex items-center justify-center">
                          <a
                            ...
                            className="inline-flex items-center gap-3 font-mono text-sm text-pale-gold hover:text-silver-white uppercase tracking-wider transition-colors duration-500"
                          >
          ...
          <Section className="relative">
            <Container className="relative z-10">
              <div className="flex flex-col gap-space-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-space-8 max-w-6xl mx-auto">
                  {values.map((value, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="bg-stone-deeper tension-border heavy-shadow p-10 relative group"
                      >
