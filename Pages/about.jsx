  ...
  const values = [
    {
      ...
      description:
        "Direct partnerships with ethical gem mines. No conflict stones, no exploitation.",
    },
    {
      icon: Users,
      title: "Multigenerational Craft",
      description:
        "Seventh-generation artisans preserving ancient techniques passed down through families.",
    },
    {
      icon: Leaf,
      title: "Sustainability",
      description:
        "No mass production. No waste. Each piece made to order with minimal environmental impact.",
    },
    {
      icon: BookOpen,
      title: "Education",
      description:
        'We teach the difference between real craft and factory-made garbage marketed as "handmade".',
    },
  ];
              ...
              >
                ...
                <div className="font-crimson text-xl text-ash-grey leading-relaxed space-y-space-4 max-w-3xl mx-auto">
                  <p className="drop-cap">
                    Between American demand for high-quality, natural, ethical
                    goods and the lack of accessible supply. In a world drowning
                    in cheap plastic garbage marketed as "premium," we educate
                    people on what is{" "}
                    <em className="text-aged-gold font-medium">REAL</em>.
                  </p>
                  <p>
                    We connect discerning clients directly to multigenerational
                    artisans who create heirloom pieces using traditional
                    methods—the same techniques their families have perfected
                  ...
                  <div className="bg-vellum metallic-border heavy-shadow p-space-8 relative">
                    ...
                    <div className="font-crimson text-lg text-ash-grey leading-relaxed space-y-space-4">
                      <p>
                        ...
                        is a workshop in Jaipur, India, where seventh-generation
                        artisans practice the ancient craft of jewelry-making
                        exactly as their ancestors did.
                      </p>
                      <p>
                        No casting machines. No assembly lines. Every piece is
                        hand-forged, hand-set, and hand-finished by master
                        craftspeople who learned their trade from their parents,
                        who learned from theirs.
                      </p>
                      <p>
                        This is{" "}
                        <em className="text-aged-gold">actual handmade</em>—not
                        the Etsy definition.
                      </p>
                    </div>
          ...
          <section className="section bg-parchment-dark relative">
            ...
            <div className="section-container relative z-10">
              <motion.h2
                ...
                viewport={{ once: true }}
                transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
                className="font-cinzel text-4xl md:text-5xl text-bone-white text-center"
              >
                Our Values
              </motion.h2>
            ...
            <div className="section-narrow relative z-10 text-center">
              ...
              >
                ...
                <p className="font-crimson text-lg text-ash-grey mb-space-6 max-w-2xl mx-auto">
                  Ready to work with artisans who still remember how to make
                  things that last?
                </p>
