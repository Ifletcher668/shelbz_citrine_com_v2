...
export default function Consultation() {
  ...
  return (
    <>
      <Head>
        <title>Book a Consultation | Heritage Jewelry</title>
        <meta
          name="description"
            ...
            <div className="section-narrow">
              ...
              >
                <div className="flex flex-col gap-space-8 max-w-4xl mx-auto">
                  <h1 className="text-5xl font-light">Book a Consultation</h1>
                  <div className="flex flex-col gap-space-4 text-lg">
                    <p>
                      45-60 minutes. In-person at our Olympia, WA studio or via
                      Zoom. We talk about what you want, look at your hands,
                      discuss budget, and figure out whether commissioning from
                      artisans 8,000 miles away makes sense for what you're
                      trying to do.
                    </p>
                    <p className="text-fog text-md">
                      Bring photos of rings you love and rings you hate—both
                      useful. If you leave and decide this isn't for you, we
                      shake hands.
                    </p>
                  </div>
                </div>
              ...
              {/* Progress Bar */}
              <div className="flex flex-col gap-space-3 mt-space-8">
                <div className="flex justify-between font-spectral text-sm text-charcoal-mist uppercase tracking-wide">
                  <span>
                ...
                <div className="h-1 bg-obsidian overflow-hidden border border-fog/20">
                  <motion.div
              ...
              <form
                ...
                className="bg-stone-deeper border-2 border-fog/20 heavy-shadow p-space-4 mt-space-8"
              >
                {/* Step 1: Contact */}
                {currentStep === 1 && (
                  <motion.div
                    ...
                    <div className="flex flex-col gap-space-5">
                      <div className="flex flex-col gap-space-1">
                        <label htmlFor="fullName" className="form-label">
                          Full Name <span className="text-pale-gold">*</span>
                        </label>
                        <input
                          type="text"
                          id="fullName"
                        ...
                        />
                        {errors.fullName && (
                          <p className="text-rust text-sm">{errors.fullName}</p>
                        )}
                      </div>

                      <div className="flex flex-col gap-space-1">
                        <label htmlFor="email" className="form-label">
                          Email <span className="text-pale-gold">*</span>
                        </label>
                        <input
                          type="email"
                          id="email"
                        ...
                        />
                        {errors.email && (
                          <p className="text-rust text-sm">{errors.email}</p>
                        )}
                      </div>
                      ...
                      <div className="flex flex-col gap-space-2">
                        <label className="form-label">
                          Consultation Type{" "}
                          <span className="text-pale-gold">*</span>
                        </label>
                        <div className="grid grid-cols-2 gap-space-4">
                          {[
                            ...
                            <button
                              ...
                              className={`p-space-4 border-2 text-left transition-all duration-300 relative ${
                                formData.consultationType === option.value
                                  ? "border-pale-gold bg-pale-gold/20 shadow-[0_0_30px_rgba(180,170,150,0.3)]"
                                  : "border-stone-grey/30 hover:border-pale-gold/50 bg-stone-deeper"
                              }`}
                            >
                              <span
                                className={`block font-mono text-md uppercase tracking-wide transition-colors ${
                                  formData.consultationType === option.value
                                    ? "text-pale-gold"
                                    : "text-silver-white"
                                }`}
                              ...
                              {formData.consultationType === option.value && (
                                <div className="absolute top-2 right-2 w-3 h-3 bg-pale-gold rounded-full shadow-[0_0_10px_rgba(180,170,150,0.6)]" />
                              )}
                            </button>
                          ))}
                        </div>
                    ...
                    <div className="flex flex-col gap-space-5">
                      <div className="flex flex-col gap-space-1">
                        <label htmlFor="budgetRange" className="form-label">
                          Budget Range <span className="text-pale-gold">*</span>
                        </label>
                        <select
                          id="budgetRange"
                        ...
                        <div className="grid grid-cols-2 gap-space-3">
                          {[
                            ...
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                updateField("metalPreference", metal)
                              }
                              className={`p-space-3 border-2 font-mono text-sm uppercase transition-all duration-300 relative ${
                                formData.metalPreference === metal
                                  ? "border-pale-gold bg-pale-gold/20 text-pale-gold shadow-[0_0_30px_rgba(180,170,150,0.3)]"
                                  : "border-stone-grey/30 text-silver-white hover:border-pale-gold/50 bg-stone-deeper"
                              }`}
                            >
                              {metal}
                            </button>
                  ...
                  >
                    <div className="flex flex-col gap-space-1">
                      ...
                      <textarea
                        ...
                        rows={6}
                      />
                      <p className="text-xs text-sepia-shadow">
