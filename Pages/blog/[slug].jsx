        ...
        <main>
          <Container size="reading" className="py-space-6">
            ...
            <div className="mb-space-8">
              <Link
                href="/blog"
                className="inline-flex items-center gap-space-2 font-display text-sm text-fog hover:text-pale-gold uppercase tracking-wide transition-colors duration-500"
              >
            ...
            >
              <div className="flex flex-col gap-space-4">
                <div className="flex flex-row gap-space-3 items-center flex-wrap">
            ...
            >
              <div className="flex flex-col gap-space-5 text-lg text-stone-grey">
