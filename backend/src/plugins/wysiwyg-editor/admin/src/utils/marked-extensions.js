 ...
 *                Reference to a Strapi relation entry. Shown as a labelled
 *                placeholder in the admin preview; resolved to HTML at build time.
 */
 ...
 * Handles alignment, callouts, columns, dividers, spacers, text, drop-cap.
 */
 ...
 * Block-level. Renders a labelled placeholder in the admin preview.
 */
const relationEmbedExtension = {
  ...
  renderer(token) {
    return `<div class="md-embed-ref"><em>${token.relType} #${token.relId}</em></div>\n`;
  },
};
